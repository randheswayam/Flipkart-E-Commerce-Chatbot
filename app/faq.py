...
# Defining file path for faq_data.csv 
faqs_path = Path(__file__).parent / "resources/faq_data.csv"
chroma_client = chromadb.Client()
client_sql = Groq()
# client_sql = Groq(api_key=os.getenv("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"))
...
def generate_answer(query, context):
    ...
    if re.match(r"^<think\b", response, re.IGNORECASE):
